  ...
  return (
    <div className="bg-gray-50 py-12">
        <div className="page-container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {filteredNews.map((article, index) => {
              ...
              return isLastElement ? (
                <div ref={lastElementRef} key={article._id}>{cardContent}</div>
              ) : (
                cardContent
              );
            })}
          ...
          {newsHasMore && (
            <div className="text-center text-gray-400 py-10 mt-4 animate-pulse uppercase tracking-widest font-black text-sm">
                Loading More...
            </div>
          )}
        </div>
